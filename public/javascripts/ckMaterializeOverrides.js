        ...
        mouseenter: function(e) {
          ...
          counterInterval = setInterval(function(){
            ...
            if (counter >= tooltip_delay && started === false) {
              console.log('newTooltip: ', newTooltip);
              started = true;
              ...
              console.log('set velocity -- newTooltip: ', newTooltip);
              newTooltip.velocity({ opacity: 1, marginTop: tooltipVerticalMovement, marginLeft: tooltipHorizontalMovement},
